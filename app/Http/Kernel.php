...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'mahasiswaPimpinan' => \App\Http\Middleware\MahasiswaPimpinanMiddleware::class,
        'mahasiswaDosen' => \App\Http\Middleware\MahasiswaDosenMiddleware::class,
        'dosenPimpinan' => \App\Http\Middleware\DosenPimpinanMiddleware::class,
    ];

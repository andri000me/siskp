                            ...
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header">
                                    <div class="float-left">
                                        <h4 class="card-title">Ganti Dosen Pembimbing Skripsi</h4>
                                    </div>
                                ...
                                <div class="card-body">
                                    {!! Form::open(['url' => 'dosen-pembimbing/skripsi/'. $dosbing->id . '/ganti', 'method' => 'patch']) !!}
                                        {{ csrf_field() }}
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <label>Dosen Pembimbing Skripsi Yang Berhalangan</label>

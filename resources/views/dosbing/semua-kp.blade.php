                    ...
                    <div class="card-body border-bottom py-2">
                        <div class="row">
                            <div class="col-12 col-lg-11">
                                ...
                                <ul class="nav nav-pills nav-justified d-lg-none">
                                    <li class="nav-item mx-0 px-0">
                                        <a class="nav-link text-info mx-0 px-0 small" href="{{ url('dosen-pembimbing/kerja-praktek/semester/'.$periode->id) }}"><span class="fa fa-info-circle"></span>&nbsp; Detail</a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="col-1 dropdown dropleft text-center d-none d-lg-flex justify-content-center align-items-center">
                                <a class="text-info small " href="{{ url('dosen-pembimbing/kerja-praktek/semester/'.$periode->id) }}">

...
<body>
        ...
        <!-- Header -->
        <br>
        <h5 class="text-center"><u> PERSETUJUAN MENGIKUTI UJIAN SEMINAR KERJA PRAKTEK</u></h5>
        <br>
        <p>
        ...
        <h5 class="text-center"> SEMINAR KERJA PRAKTEK</h5>
        <br>
        
        <div class="float-left">
            <p>Dosen Pembimbing 1</p>
            <br> <br>
            <small><u>{{ $dosbing->dosbingSatuKp->nama }}</u> <br>
            NIP: {{ $dosbing->dosbingSatuKp->nip }}</small>
        </div>

        <div class="float-right">
            <p> Dosen Pembimbing 2</p>
            <br> <br>
            <small><u>{{ $dosbing->dosbingDuaKp->nama }}</u> <br>
            NIP: {{ $dosbing->dosbingDuaKp->nip }}</small>
        </div>

...
<body>
        ...
        <!-- Header -->
        <h5 class="text-center"> LEMBAR PENILAIAN <br> UJIAN SEMINAR HASIL SKRIPSI</h5>
        <table class="table borderless">
            <tr>
                <td>Nama</td>
        ...
        <!-- Header -->
        <h5 class="text-center"> LEMBAR REVISI <br> UJIAN SEMINAR HASIL SKRIPSI</h5>
        <br>
        <table class="table borderless">
            <tr>
                <td>Nama & NIM</td>
        ...
        <!-- Header -->
        <h5 class="text-center"> PRESENSI KEHADIRAN <br> UJIAN SEMINAR HASIL SKRIPSI</h5>
        <br>
        <table class="table borderless">
            <tr>
                <td>Nama & NIM</td>
        ...
        <!-- Header -->
        <h6 class="text-left"> PRESENSI KEHADIRAN PESERTA UJIAN SEMINAR HASIL SKRIPSI</h6>

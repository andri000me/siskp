...
<body>
        ...
        <!-- Header -->
        <h5 class="text-center"> LEMBAR PENILAIAN <br> UJIAN SIDANG SKRIPSI</h5>
        <table class="table borderless">
            <tr>
                <td>Nama</td>
        ...
        <!-- Header -->
        <h5 class="text-center"> LEMBAR REVISI <br> UJIAN SIDANG SKRIPSI</h5>
        <br>
        <table class="table borderless">
            <tr>
                <td>Nama & NIM</td>
        ...
        <!-- Header -->
        <h5 class="text-center"> PRESENSI KEHADIRAN <br> UJIAN SIDANG SKRIPSI</h5>
        <br>
        <table class="table borderless">
            <tr>
                <td>Nama & NIM</td>

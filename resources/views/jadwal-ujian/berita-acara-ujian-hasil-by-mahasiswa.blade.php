...
<body>
        ...
        @endif
        <br> <br>
        <p style="font-size:10px;">{{ implode(' ', array_slice(explode(' ', $dosen->dospengSatuHasil->nama), 0, 2)) }}</p>
    </div>
    ...
    <div class="float-left mx-5">
        ...
        @endif
        <br> <br>
        <p style="font-size:10px;">{{ implode(' ', array_slice(explode(' ', $dosen->dospengDuaHasil->nama), 0, 2)) }}</p>
    </div>

...
<body>
    ...
    <div class="float-left mr-4 ml-0 pl-0">
        <p>Penguji 1</p>
        @if(!empty($dosen->dospengSatuProposal->tanda_tangan))
        <img src="{{ asset('assets/ttd/' . $dosen->dospengSatuProposal->tanda_tangan) }}" style="width:25%; padding-left:-30px;" class="img pt-2">
        @endif
        <br> <br>
        <p style="font-size:10px;">{{ implode(' ', array_slice(explode(' ', $dosen->dospengSatuProposal->nama), 0, 2)) }}</p>
    </div>

    <div class="float-left mx-5">
        <p>Penguji 2</p>
        @if(!empty($dosen->dospengDuaProposal->tanda_tangan))
        <img src="{{ asset('assets/ttd/' . $dosen->dospengDuaProposal->tanda_tangan) }}" style="width:25%; padding-left:-30px;" class="img pt-2">
        @endif
        <br> <br>
        <p style="font-size:10px;">{{ implode(' ', array_slice(explode(' ', $dosen->dospengDuaProposal->nama), 0, 2)) }}</p>
    </div>

    <div class="float-left mx-5">
        <p>Penguji 3</p>
        @if(!empty($dosen->dospengTigaProposal->tanda_tangan))
        <img src="{{ asset('assets/ttd/' . $dosen->dospengTigaProposal->tanda_tangan) }}" style="width:25%; padding-left:-30px;" class="img pt-2">
        @endif
        <br> <br>
        <p style="font-size:10px;">{{ implode(' ', array_slice(explode(' ', $dosen->dospengTigaProposal->nama), 0, 2)) }} </p>
    </div>

    <div class="float-left mx-5" >
        <p>Penguji 4</p>
        @if(!empty($dosen->dospengEmpatProposal->tanda_tangan))
        <img src="{{ asset('assets/ttd/' . $dosen->dospengEmpatProposal->tanda_tangan) }}" style="width:25%; padding-left:-30px;" class="img pt-2">
        @endif
        <br> <br>
        <p style="font-size:10px;">{{ implode(' ', array_slice(explode(' ', $dosen->dospengEmpatProposal->nama), 0, 2)) }}</p>
    </div>

    <div class="float-left ml-5 mr-0 pr-0" >
        <p>Penguji 5</p>
        @if(!empty($dosen->dospengLimaProposal->tanda_tangan))
        <img src="{{ asset('assets/ttd/' . $dosen->dospengLimaProposal->tanda_tangan) }}" style="width:25%; padding-left:-30px;" class="img pt-2">
        @endif
        <br> <br>
        <p style="font-size:10px;">{{ implode(' ', array_slice(explode(' ', $dosen->dospengLimaProposal->nama), 0, 2)) }}</p>
    </div>

...
@section('main')
                ...
                <div class="card mb-3">
                    <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                        <strong class="bg-primary text-light">Form Berita Acara Kerja Praktek (Ada Nilai & TTD)</strong>
                    ...
                    <div class="card-body border-bottom py-2">
                        {!! Form::open(['url' => 'jadwal-ujian/berita-acara-kerja-praktek-ttd']) !!}
                        {{ csrf_field() }}
                        ...
                        {!! Form::hidden('id_mahasiswa', $jadwal->id_mahasiswa) !!}
                            ...
                            <div class="form-row">
                                <div class="form-group col-12">
                                    <label>Judul</label>
                                    {!! Form::textarea('judul', old('judul'), ['class' => 'form-control', 'style' => 'height:80px', 'required' => 'required']) !!}
                                </div>
                            </div>

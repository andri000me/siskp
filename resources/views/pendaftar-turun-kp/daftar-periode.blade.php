                ...
                <nav class="navbar mb-2 navbar-expand-lg navbar-light justify-content-between border mb-1 mx-0 mt-0 shadow-sm">
                    ...
                    <div class="dropdown dropleft">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="{{ url('pendaftaran/turun-kp/' . $id . '/input-by-admin') }}">Input Pendaftar Turun KP</a>
                        </div>
                    </div>
                </nav>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                {!! Form::open(['url' => 'pendaftaran/turun-kp/setujui-semua']) !!}
                                    {!! Form::hidden('id_periode_daftar_turun_kp', $id) !!}
                            ...
                            <div class="col-12 col-lg-11">
                                ...
                                <ul class="nav nav-pills nav-justified d-lg-none">
                                    <li class="nav-item mx-0 px-0">
                                            <a class="nav-link text-info mx-0 px-0 small" href="{{ url('pendaftaran/turun-kp/'.$pendaftar->id) }}"><span class="fa fa-info-circle"></span>&nbsp; Detail</a>
                                            </li>
                                        ...
                                        <li class="nav-item mx-0 px-0">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ url('pendaftaran/turun-kp/'.$pendaftar->id.'/create-dosbing') }}">Input Dosen Pembimbing</a>

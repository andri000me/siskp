...
@section('main')
                                ...
                                <div class="d-lg-none d-flex modal-dialog" style="position:absolute; bottom:0; width:100%; margin:0; padding:0;">
                                    <div class="modal-content">
                                        <div class="modal-body text-dark h6 pb-0">
                                            <p><a class="d-block text-dark" href="{{ url('pendaftaran/turun-kp/' . $id . '/input-by-admin') }}"><i class="fa fa-plus fa-fw"></i> Input pendaftar turun KP</a></p>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-body text-dark h6 text-center">
                                            ...
                                            <p>
                                                Yakin Menyetujui semua berkas pada periode turun kerja praktek <strong>{{ $periode->nama }}</strong> ?
                                            </p>
                                            <div class="row">
                                                ...
                                                {!! Form::open(['url' => 'pendaftaran/turun-kp/setujui-semua', 'class' => 'col']) !!}
                                                    {!! Form::hidden('id_periode_daftar_turun_kp', $id) !!}
                ...
                <div class="card">
                    <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                        <strong class="bg-primary text-light">Pendaftar Turun KP {{ $periode->nama }}</strong>
                                ...
                                <div class="d-lg-none d-flex modal-dialog" style="position:absolute; bottom:0; width:100%; margin:0; padding:0;">
                                    <div class="modal-content">
                                        <div class="modal-body text-dark h6 pb-0">
                                            ...
                                            <p><a class="d-block text-dark" href="{{ url('pendaftaran/turun-kp/'.$pendaftar->id.'/create-dosbing') }}"><i class="fa fa-fw fa-plus"></i> Input dosen pembimbing</a></p>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-body text-dark h6 text-center">
                                            ...
                                            <p>
                                                Yakin menghapus <strong>{{ $pendaftar->mahasiswa->nama }} ({{ $pendaftar->mahasiswa->nim }})</strong> dari periode daftar turun kerja praktek <strong>{{ $pendaftar->periodeDaftarTurunKp->nama }}</strong> ? Data yang sudah dihapus tidak bisa dikembalikan.
                                            </p>
                                            <div class="row">
                                                <button type="button" class="col btn btn-light btn-sm btn-block text-dark" data-dismiss="modal"><i class="fa fa-times-circle"></i> Tutup</button>
                ...
                <nav class="pagination pagination-sm my-2 text-truncate">
                    {{ $daftar_turun_kp->onEachSide(1)->links() }}
                </nav>
@stop
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-body text-dark h6 text-center">
                                            ...
                                            <p>
                                                Yakin menghapus berkas ujian <strong>{{ ucwords(str_replace('-', ' ', $pendaftar->ujian)) }}</strong> anda dari periode <strong>{{ $pendaftar->periodeDaftarUjian->nama }}</strong> ? Data yang sudah dihapus tidak bisa dikembalikan.
                                            </p>
                                            <div class="row">

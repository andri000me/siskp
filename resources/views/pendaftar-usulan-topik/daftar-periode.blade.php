                ...
                <nav class="navbar mb-2 navbar-expand-lg navbar-light justify-content-between border mb-1 mx-0 mt-0 shadow-sm">
                    ...
                    <div class="dropdown dropleft">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="{{ url('pendaftaran/usulan-topik/' . $id . '/input-by-admin') }}">Input Pendaftar Usulan Topik</a>
                        </div>
                    </div>
                </nav>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                {!! Form::open(['url' => 'pendaftaran/usulan-topik/setujui-semua']) !!}
                                    {!! Form::hidden('id_periode_daftar_usulan_topik', $id) !!}
                                ...
                                <ul class="nav nav-pills nav-justified d-lg-none">
                                    <li class="nav-item mx-0 px-0">
                                        ...
                                        <li class="nav-item mx-0 px-0">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ url('pendaftaran/usulan-topik/'.$pendaftar->id.'/create-dosbing') }}">Input Dosen Pembimbing</a>
                                                <a class="dropdown-item" href="{{ url('pendaftaran/usulan-topik/cetak/'.$pendaftar->id) }}">Unduh</a>

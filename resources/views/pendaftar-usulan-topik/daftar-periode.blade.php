...
@section('main')
                                ...
                                <div class="d-lg-none d-flex modal-dialog" style="position:absolute; bottom:0; width:100%; margin:0; padding:0;">
                                    <div class="modal-content">
                                        <div class="modal-body text-dark h6 pb-0">
                                            <p><a class="d-block text-dark" href="{{ url('pendaftaran/usulan-topik/' . $id . '/input-by-admin') }}"><i class="fa fa-plus fa-fw"></i> Input pendaftar usulan topik</a></p>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-body text-dark h6 text-center">
                                            ...
                                            <p>
                                                Yakin Menyetujui semua berkas pada periode Usulan Topik <strong>{{ $periode->nama }}</strong> ?
                                            </p>
                                            <div class="row">
                                                ...
                                                {!! Form::open(['url' => 'pendaftaran/usulan-topik/setujui-semua', 'class' => 'col']) !!}
                                                    {!! Form::hidden('id_periode_daftar_usulan_topik', $id) !!}
                ...
                <div class="card">
                    <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                        <strong class="bg-primary text-light">Pendaftar Usulan Topik {{ $periode->nama }}</strong>
                                ...
                                <div class="d-lg-none d-flex modal-dialog" style="position:absolute; bottom:0; width:100%; margin:0; padding:0;">
                                    <div class="modal-content">
                                        <div class="modal-body text-dark h6 pb-0">
                                            ...
                                            <p><a class="d-block text-dark" href="{{ url('pendaftaran/usulan-topik/'.$pendaftar->id.'/create-dosbing') }}"><i class="fa fa-fw fa-plus"></i> Input dosen pembimbing</a></p>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-body text-dark h6 text-center">
                                            ...
                                            <p>
                                                Yakin menghapus <strong>{{ $pendaftar->mahasiswa->nama }} ({{ $pendaftar->mahasiswa->nim }})</strong> dari periode daftar usulan topik  <strong>{{ $pendaftar->periodeDaftarUsulanTopik->nama }}</strong> ? Data yang sudah dihapus tidak bisa dikembalikan.
                                            </p>
                                            <div class="row">
                                                <button type="button" class="col btn btn-light btn-sm btn-block text-dark" data-dismiss="modal"><i class="fa fa-times-circle"></i> Tutup</button>
                ...
                <nav class="pagination pagination-sm my-2 text-truncate">
                    {{ $daftar_usulan_topik->onEachSide(1)->links() }}
                </nav>
@stop
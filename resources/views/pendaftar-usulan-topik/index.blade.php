...
@section('main')
                            ...
                            <div id="pencarian" class="collapse my-2 pb-1" data-parent="#filter">
                                <div class="card">
                                    <div class="card-body m-0">
                                        <p class="my-0 py-0">
                                            Persyaratan & Ketentuan Usulan Topik & Judul Skripsi adalah sebagai berikut: <br>
                                            ...
                                            3). Program Studi telah anda diinputkan ke Sistem. <small><a href="{{ url('profil') }}">Cek disini</a> </small> 
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <p class="card-title h6 text-center font-weight-bold my-0 py-3">
                                    Periode Pendaftaran Usulan Topik & Judul Skripsi Belum Ada Yang Dibuka!
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            @else
                <nav class="navbar mb-2 navbar-expand-lg navbar-light justify-content-between border mb-1 mx-0 mt-0 shadow-sm">
                    ...
                    <a class="text-primary" href="{{ url('pendaftaran/usulan-topik/create?id='.$periode_aktif->id) }}"><span class="fa fa-edit"></span> <span class="">Daftar</span></a>
                </nav>

                <div class="card mb-2">
                    <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                        <strong class="bg-primary text-light">Periode Usulan Topik & Judul Skripsi {{ $periode_aktif->nama }}  
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-11">
                                ...
                                <p class="my-0 py-0 text-capitalize text-truncate">
                                    ...
                                    {{ !empty($pendaftar->usulan_judul) ? $pendaftar->usulan_judul : '-'}}<br>
            ...
            @if(Session::has('mahasiswa'))
                <div class="card mb-2">
                    <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                        <strong class="bg-primary text-light">Riwayat Usulan Topik Saya</small>
                        </strong>
                        <a class="text-white d-none d-lg-inline" href="{{ url()->previous() }}">
                            <span class="fa fa-arrow-left"></span> <span class="">Kembali</span>
                        </a>
                ...
                <!-- jika data ada -->
                <?php $i=1 ?>
                @foreach($daftar_usulan_topik as $pendaftar)
                    <div class="card-body border-bottom py-2">
                        <div class="row">
                            <div class="col-12 col-lg-11">
                                <p class="card-title font-weight-bold text-capitalize text-truncate my-0 py-0">{{ $i }}). {{ $pendaftar->usulan_judul }}</p>
                                <p class="my-0 py-0 text-capitalize">
                                    {{ !empty($pendaftar->periodeDaftarUsulanTopik->nama) ? $pendaftar->periodeDaftarUsulanTopik->nama : '-' }} <br>
                                    @if($pendaftar->tahapan === 'diperiksa')
                                        <span class="text-dark"> <i class="fa fa-hourglass-half"></i> Diperiksa</span>
                                    @elseif($pendaftar->tahapan === 'diterima')
                                        <span class="text-primary"><i class="fa fa-check"></i> Diterima</span>
                                ...
                                <!-- menu mobile -->
                                <ul class="nav nav-pills nav-justified d-lg-none">
                                        <li class="nav-item mx-0 px-0"><a class="nav-link text-info mx-0 px-0 small" href="{{ url('pendaftaran/usulan-topik/'.$pendaftar->id) }}"><span class="fa fa-info-circle"></span>&nbsp;
                                                Detail</a></li>
                                        
                                        @if($pendaftar->tahapan === 'diperiksa')
                                        <li class="nav-item mx-0 px-0"><a class="nav-link text-success mx-0 px-0 small" href="{{ url('pendaftaran/usulan-topik/'. $pendaftar->id .'/edit') }}"><span class="fa fa-edit"></span>&nbsp;
                                                Edit</a></li>

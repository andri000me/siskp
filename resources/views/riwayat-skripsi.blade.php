...
@section('main-masuk')
            <div class="col-12 col-lg-9 my-2">
                ...
                <div class="accordion mb-2 d-none d-lg-inline" id="filter">
                    <button class="btn btn-outline-primary btn-sm btn-block" type="button" data-toggle="collapse" data-target="#pencarian"><span class="fa fa-search"></span> Cari </button>
                    ...
                    <div class="card-body border-bottom py-2 text-truncate">
                        ...
                        <ul class="nav nav-pills nav-justified">
                            ...
                            <li class="nav-item mx-0 px-0">
                                <a class="nav-link text-info mx-0 px-0 small" href="{{ url('masuk/riwayat-skripsi/' . $pendaftar->id_mahasiswa) }}"><span class="fa fa-info-circle"></span>&nbsp;
                                        Detail</a></li>
                            </li>

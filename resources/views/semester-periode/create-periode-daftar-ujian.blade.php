...
@section('main')
                ...
                <div class="card mb-3">
                    <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                        <strong class="bg-primary text-light">Tambah Periode Daftar Ujian</strong>
                    ...
                    <div class="card-body border-bottom py-2">
                        {!! Form::open(['url' => 'semester-periode/periode-daftar-ujian']) !!}
                            {{ csrf_field() }}
                            ...
                            <div class="form-row">
                                <div class="form-group col-12">
                                    ...
                                    {!! Form::text('nomor_undangan', old('nomor_undangan'), ['class' => 'form-control', 'required' => 'required']) !!}
                                </div>
                            </div>

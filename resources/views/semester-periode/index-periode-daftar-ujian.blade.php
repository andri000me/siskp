...
@section('main')
                ...
                <div class="card mb-3">
                    <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                        <strong class="bg-primary text-light">Periode Daftar Ujian</strong>
                        
                        <a class="text-white" href="{{ url('semester-periode/periode-daftar-ujian/create') }}">
                    ...
                    <!-- jika data ada -->
                    <?php $i=1 ?>
                    @foreach($daftar_periode_daftar_ujian as $periode)
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-11">
                                ...
                                <p class="my-0 py-0 text-dark">
                                    ...
                                    No. Undangan Penguji: {{ $periode->nomor_undangan }} <br>
                                    Semester {{ !empty($periode->semester->nama) ? $periode->semester->nama : '-' }} <br>
                                    Pendaftar : {{ number_format($periode->pendaftarUjian->count(), 0, ',', '.') }} Mahasiswa
                                </p>

                                <!-- menu mobile -->
                                <ul class="nav nav-pills nav-justified d-lg-none">
                                    <li class="nav-item mx-0 px-0">
                                        <a class="nav-link text-success mx-0 px-0 small" href="{{ url('semester-periode/periode-daftar-ujian/'. $periode->id .'/edit') }}"><span class="fa fa-edit"></span>&nbsp; Edit</a>
                                    </li>
                                    <li class="nav-item mx-0 px-0">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-body text-dark h6 pb-0">
                                            <p><a class="d-block text-dark" href="{{ url('semester-periode/periode-daftar-ujian/'. $periode->id .'/edit') }}"><i class="fa fa-fw fa-edit"></i> Edit</a></p>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-body text-dark h6 text-center">
                                            ...
                                            <p>
                                                Yakin menghapus Periode Daftar Ujian <strong>{{ $periode->nama }}</strong> ? Data yang sudah dihapus tidak bisa dikembalikan.
                                            </p>
                                            <div class="row">
                                                ...
                                                {!! Form::open(['url' => 'semester-periode/periode-daftar-ujian/'.$periode->id , 'method' => 'delete', 'class' => 'col']) !!}
                ...
                <nav class="pagination pagination-sm my-2 text-truncate">
                    {{ $daftar_periode_daftar_ujian->onEachSide(1)->links() }}
                </nav>

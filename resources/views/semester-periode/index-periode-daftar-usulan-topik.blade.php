...
@section('main')
                ...
                <div class="card mb-3">
                    <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                        <strong class="bg-primary text-light">Periode Daftar Usulan Topik</strong>
                    ...
                    <!-- jika data ada -->
                    <?php $i=1 ?>
                    @foreach($daftar_periode_daftar_usulan_topik as $periode)
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-11">
                                ...
                                <p class="my-0 py-0 text-dark">
                                    ...
                                    Pendaftar : {{ number_format($periode->pendaftarUsulanTopik->count(), 0, ',', '.') }} Mahasiswa
                                </p>

                                <!-- menu mobile -->
                                <ul class="nav nav-pills nav-justified d-lg-none">
                                    <li class="nav-item mx-0 px-0">
                                        <a class="nav-link text-success mx-0 px-0 small" href="{{ url('semester-periode/periode-daftar-usulan-topik/'. $periode->id .'/edit') }}"><span class="fa fa-edit"></span>&nbsp; Edit</a>
                                    </li>
                                    <li class="nav-item mx-0 px-0">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-body text-dark h6 pb-0">
                                            <p><a class="d-block text-dark" href="{{ url('semester-periode/periode-daftar-usulan-topik/'. $periode->id .'/edit') }}"><i class="fa fa-fw fa-edit"></i> Edit</a></p>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-body text-dark h6 text-center">
                                            ...
                                            <p>
                                                Yakin menghapus Periode Daftar Usulan Topik <strong>{{ $periode->nama }}</strong> ? Data yang sudah dihapus tidak bisa dikembalikan.
                                            </p>
                                            <div class="row">
                                                ...
                                                {!! Form::open(['url' => 'semester-periode/periode-daftar-usulan-topik/'.$periode->id , 'method' => 'delete', 'class' => 'col']) !!}
                ...
                <nav class="pagination pagination-sm my-2 text-truncate">
                    {{ $daftar_periode_daftar_usulan_topik->onEachSide(1)->links() }}
                </nav>
@stop
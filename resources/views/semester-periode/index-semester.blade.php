                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-body text-dark h6 pb-0">
                                            <p><a class="d-block text-dark" href="{{ url('semester-periode/semester/'. $periode->id .'/edit') }}"><i class="fa fa-fw fa-edit"></i> Edit</a></p>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-body text-dark h6 text-center">
                                            ...
                                            <p>
                                                Yakin menghapus Semester <strong>{{ $periode->nama }}</strong> ? Data yang sudah dihapus tidak bisa dikembalikan.
                                            </p>
                                            <div class="row">
                                                ...
                                                {!! Form::open(['url' => 'semester-periode/semester/'.$periode->id , 'method' => 'delete', 'class' => 'col']) !!}
